...
import Photo from "@/views/user/profile/component/Photo.vue";
import Username from "@/views/user/profile/component/Username.vue";
import Profile from "@/views/user/profile/component/Profile.vue";
